// 01 · WELCOME — blocked: biometric
function ScreenWelcomeBlocked_biometric() {
    ...
    <Phone>
      <div style={{padding:"0 24px", display:"flex", flexDirection:"column", height:"100%", justifyContent:"space-between", paddingBottom:24}}>
        <div style={{paddingTop:40}}>
          ...
          <div style={{
            ...
            {checks.map(([label, ok_value]) => {
              const failing = label === "biometric";
              return <Row key={label} ok={!failing} label={label} value={failing ? "not enrolled" : ok_value}/>;
            })}
        ...
        <div style={{display:"flex", flexDirection:"column", gap:8}}>
          <Btn full>open android settings →</Btn>
          <div style={{
...
window.ScreenWelcomeBlocked_biometric = ScreenWelcomeBlocked_biometric;
