            ...
            <div key={folder}>
              ...
              {entries.map((e, i) => (
                <div key={e} style={{
                  ...
                  borderBottom:`1px solid ${T.border}`,
                  cursor:"pointer",
                  background: e==="gmail" ? T.accentDim : "transparent",
                }}>
                  <span style={{color:T.textFaint, fontSize:10, marginRight:8, fontFamily:T.mono}}>
                    {i < entries.length-1 ? "├─" : "└─"}
                  </span>
...
window.ScreenHomeTree = ScreenHomeTree;
